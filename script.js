...
// const guesst1 = restaurant.numGuests ? restaurant.numGuests : 10;
// console.log(guesst1);

// const guesst2 = restaurant.numGuests || 10;
// console.log(guesst2);
...
// // 4
// const players1Final = [...player1, 'Thiago', 'Coutinhn', 'Periscic'];
...
// // Array
// const users = [{name: 'jonas', gmail: 'hello@jonas.io'}];
...
console.log(ordersSet.add('Garlic bread'));
console.log(ordersSet.delete('Ristto'));
console.log(ordersSet);
